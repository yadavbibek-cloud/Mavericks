...
# Serve frontend static assets (Map Explorer GIS Dashboard)
frontend_map_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "frontend", "map-explorer")
frontend_root_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "frontend")

static_dir = frontend_map_dir if os.path.exists(os.path.join(frontend_map_dir, "index.html")) else frontend_root_dir
