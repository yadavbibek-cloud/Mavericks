...
class RiskPredictor:
    def __init__(self, model_path: str = "models/gridsense_gnn.pt", norm_path: str = "models/feature_norm.json"):
    ...
    def predict(self, grid_state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not nodes:
            return {"node_risk": {}, "time_to_critical": {}, "predicted_failures": []}
        ...
        for idx, n in enumerate(nodes):
            ...
            risk = round(min(0.99, max(0.01, model_prob)), 2)
